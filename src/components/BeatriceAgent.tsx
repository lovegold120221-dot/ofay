...
const SILENCE_FILLER_STYLES = [
  ...
  },
  {
    ...
    minCount: 0,
    maxCount: 5,
    instruction: 'Sing a few lines from a well-known pop or rock song with genuine vocal beauty and emotion. Sing at least 4-6 seconds worth with real melody. NEVER repeat a song you have already used. Choose from: "Let It Be" (Beatles), "Hallelujah" (Cohen), "Someone Like You" (Adele), "Fix You" (Coldplay), "Flowers" (Miley Cyrus), "Easy On Me" (Adele), "Drivers License" (Olivia Rodrigo), "As It Was" (Harry Styles), "Anti-Hero" (Taylor Swift), "Vampire" (Olivia Rodrigo), "What Was I Made For?" (Billie Eilish), "Dance The Night" (Dua Lipa), "Lose Control" (Teddy Swims), "Beautiful Things" (Benson Boone), "Espresso" (Sabrina Carpenter), or any other well-known beautiful song you have NOT used before. Trail off naturally with a soft sigh or hum at the end.',
  },
  {
    key: 'sing-tagalog',
    weight: 4,
  ...
  },
  {
    ...
    minCount: 0,
    maxCount: 2,
    instruction: 'Sing a few lines from a gentle acoustic or indie song with warm, intimate vocal delivery. Keep it soft and heartfelt. NEVER repeat a song you have already used. Choose from: "Riptide" (Vance Joy), "Holocene" (Bon Iver), "Skinny Love" (Birdy), "Budapest" (George Ezra), "River" (Leon Bridges), "Bloom" (The Paper Kites), "ceilings" (Lizzy McAlpine), "Stick Season" (Noah Kahan). Trail off softly.',
  },
  {
    key: 'sing-latin',
    weight: 2,
    minCount: 0,
    maxCount: 2,
    instruction: 'Sing a few lines from a beautiful Latin or Spanish song with genuine passion and warmth. Sing at least 4-6 seconds worth. NEVER repeat a song you have already used. Choose from: "Colgando En Tus Manos" (Carlos Baute), "El Perdón" (Enrique Iglesias), "Bailando" (Enrique Iglesias), "Despacito" (Luis Fonsi), "Shakira: BZRP Music Sessions" (Shakira), "Si No Estás" (Rosario), "De Vuelta Pa\' La Vuelta" (Daddy Yankee), "Monotonía" (Shakira). Trail off with a soft sigh.',
  },
] as const;
